...
class Widget_HumanlikeDev_Twitter_Slider_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-twiter-slider-block';
	}
				...
				<div data-twitter-flickity=\'{"wrapAround": true, "autoPlay": false, "prevNextButtons": false, "adaptiveHeight": true}\' data-twitter-fetcher data-username="'. $settings['twitter_username'] .'">
					<div class="carousel-cell">
						...
						<div class="d-flex align-items-center">
							'. humanlikedev_svg_icons_pluck( 'Twitter Icon', 'icon icon-sm mr-2 opacity-30' ) .'
				...
				<div class="row" data-twitter-fetcher data-username="'. $settings['twitter_username'] .'" data-twitter-isotope data-sort-ascending="true">
					<div class="col-md-4" data-isotope-item>
						<div class="card card-body align-items-start">
							'. humanlikedev_svg_icons_pluck( 'Twitter Icon', 'icon mb-3 bg-primary' ) .'
					...
					<div class="col-md-6" data-isotope-item>
						<div class="card card-body flex-row">
							<div class="icon-round icon-round-sm bg-primary">
								'. humanlikedev_svg_icons_pluck( 'Twitter Icon', 'icon bg-primary' ) .'
							</div>
							<div class="ml-3">
								<p class="tweet"></p>
								<span class="text-small timePosted"></span>
	...
	protected function _content_template() {
		...
		<# } else if ( 'slider_widget' == settings.layout ) { #>
			...
			<div data-twitter-flickity='{"wrapAround": true, "autoPlay": false, "prevNextButtons": false, "adaptiveHeight": true}' data-twitter-fetcher data-username="{{ settings.twitter_username }}">
				<div class="carousel-cell">
					<div class="tweet mb-2"></div>
					<div class="d-flex align-items-center">
						<?php echo humanlikedev_svg_icons_pluck( 'Twitter Icon', 'icon icon-sm mr-2 opacity-30' ); ?>
						<div class="timePosted text-small"></div>
					</div>
				</div>
			</div>
		...
		<# } else if ( 'cards_1' == settings.layout ) { #>
			...
			<div class="row" data-twitter-fetcher data-username="{{ settings.twitter_username }}" data-twitter-isotope data-sort-ascending="true">
				<div class="col-md-4" data-isotope-item>
					<div class="card card-body align-items-start">
						<?php echo humanlikedev_svg_icons_pluck( 'Twitter Icon', 'icon mb-3 bg-primary' ); ?>
						<p class="tweet w-100"></p>
						<span class="text-small timePosted"></span>
					</div>
				</div>
		...
		<# } else if ( 'cards_2' == settings.layout ) { #>
			...
			<div class="row" data-twitter-fetcher data-username="{{ settings.twitter_username }}" data-twitter-isotope data-sort-ascending="true">
				<div class="col-md-6" data-isotope-item>
					<div class="card card-body flex-row">
						<div class="icon-round icon-round-sm bg-primary">
							<?php echo humanlikedev_svg_icons_pluck( 'Twitter Icon', 'icon bg-primary' ); ?>
						</div>
						<div class="ml-3">
							<p class="tweet"></p>
							<span class="text-small timePosted"></span>
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Twitter_Slider_Block() );