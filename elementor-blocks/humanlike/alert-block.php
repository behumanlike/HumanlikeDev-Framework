...
class Widget_HumanlikeDev_Alert_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-alert-block';
	}
			...
			if(!( 'None' == $settings['icon'] )){
				...
				echo '
					<div class="alert '. $settings['style'] .'" role="alert">
						<div class="d-flex">'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon bg-primary' ) .'
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Alert_Block() );