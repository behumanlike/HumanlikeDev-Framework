...
class Widget_HumanlikeDev_Card_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-card-block';
	}
	...
	protected function render() {
		...
		if( 'basic' == $settings['layout'] ) {
				...
				echo '
					<a '. $link .' class="card card-body">
						<div class="icon-round mb-3 mb-md-4 bg-primary">
							'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon bg-primary' ) .'	
						</div>			
				...
				echo '
					<a '. $link .' class="card card-body bg-primary text-light">
						<div class="icon-round mb-3 mb-md-4 icon bg-white">
							'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon bg-white' ) .'	
						</div>				
						<h4>'. $settings['title'] .'</h4>	
						'. $settings['content'] .'
					</a>
			...
			if( !empty( $settings['url']['url'] ) ) {
				...
				echo '
					<div class="card card-icon-2 card-body justify-content-between">
						<div class="icon-round mb-3 mb-md-4 bg-primary">
							'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon bg-primary-2' ) .'
						</div>
						<h5 class="mb-0">'. $settings['title'] .'</h5>
					</div>
				';
				...
				echo '
					<a '. $link .' class="card card-icon-3 card-body justify-content-between shadow-3d rotate-left">
						<div class="icon-round mb-3 mb-md-4 bg-primary-3">
							'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon bg-primary-3' ) .'
					 	</div>
			...
			if( !empty( $settings['url']['url'] ) ) {
				...
				echo '
					<a '. $link .' class="card card-sm card-body flex-row align-items-center hover-shadow-3d">					
						'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-lg bg-primary', $settings['image']['url'] ) .'	             	
	                  	<div class="ml-3">
	                  		<h5 class="mb-0">'. $settings['title'] .'</h5>
		                    '. $settings['content'] .'
	                  	</div>
			...
			if( !empty( $settings['url']['url'] ) ) {
				...
				echo '
					<a '. $link .' class="card card-sm card-body flex-row align-items-center hover-shadow-3d">					
						'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-lg bg-primary-2', $settings['image']['url'] ) .'	             	
	                  	<div class="ml-3">
	                  		<h5 class="mb-0">'. $settings['title'] .'</h5>
		                    '. $settings['content'] .'
	                  	</div>
				...
				echo '
					<div class="card card-customer-1 card-body align-items-start">
					  <div class="mb-4 mb-md-5">
					    '. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-lg bg-primary-2' ) .'
					  </div>
				...
				echo '
					<div class="card">
	                  	...
	                  	<div class="card-body align-items-start">
	                    	<div class="mb-3">
	                    		'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-md' ) .'
	                    	</div>
		                     '. $settings['content'] .'
	                  	</div>
	                </div>
				...
				echo '
					<a '. $link .' class="card card-body">
					  	<div class="d-flex mb-3">
					    	'. humanlikedev_svg_icons_pluck( 'Star', $class = 'icon bg-warning' ) .'
					    	'. humanlikedev_svg_icons_pluck( 'Star', $class = 'icon bg-warning' ) .'
					    	'. humanlikedev_svg_icons_pluck( 'Star', $class = 'icon bg-warning' ) .'
					    	'. humanlikedev_svg_icons_pluck( 'Star', $class = 'icon bg-warning' ) .'
					    	'. humanlikedev_svg_icons_pluck( 'Star', $class = 'icon bg-warning' ) .'
			...
			echo '
				<a '. $link .' class="card card-article-wide flex-md-row no-gutters hover-shadow-3d">
						...
						<div>
							'. humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-md mb-4' ) .'
							'. $settings['content'] .'
						</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Card_Block() );