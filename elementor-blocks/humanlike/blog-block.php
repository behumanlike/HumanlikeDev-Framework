...
class Widget_HumanlikeDev_Blog_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-blog-block';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'layout', [
				...
				'default' => 'card',
				'options' => humanlikedev_get_blog_layouts(),
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Blog_Block() );