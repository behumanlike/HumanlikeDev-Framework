...
class Widget_HumanlikeDev_Portfolio_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-portfolio-block';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'layout', [
				...
				'default' => '2-columns',
				'options' => humanlikedev_get_portfolio_layouts(),
			]
		);
		...
		$this->add_control(
			'show_filters', [
				...
				'default' => 'show',
				'options' => [
					'hide'          	=> esc_html__( 'Hide Filters', 'tr-framework' ),
					'show'         		=> esc_html__( 'Show Filters', 'tr-framework' ),
				],
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Portfolio_Block() );