...
class Widget_HumanlikeDev_Team_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-team-block';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'layout', [
				...
				'default' => '4-columns',
				'options' => humanlikedev_get_team_layouts(),
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Team_Block() );