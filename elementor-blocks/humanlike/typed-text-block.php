...
class Widget_HumanlikeDev_Typed_Text_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-typed-text-block';
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Typed_Text_Block() );