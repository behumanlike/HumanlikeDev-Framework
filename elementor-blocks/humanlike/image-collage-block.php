...
class Widget_HumanlikeDev_Image_Collage_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-image-collage-block';
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Image_Collage_Block() );