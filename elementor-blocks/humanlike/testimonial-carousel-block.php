...
class Widget_HumanlikeDev_Testimonial_Carousel_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-testimonial-carousel-block';
	}
				                ...
				                <div class="card card-body">
				                  	...
				                  	if( $item['rating'] ) {
				                  		if ( strpos( $item['rating'], "." ) ) {
									      	...
									      	echo humanlikedev_svg_icons_pluck( 'Half Star', $class = 'icon bg-warning' );
									    } else {
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Testimonial_Carousel_Block() );