...
class Widget_HumanlikeDev_Clients_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-clients-block';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'layout', [
				...
				'default' => 'small',
				'options' => array_flip( humanlikedev_get_client_layouts() ),
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Clients_Block() );