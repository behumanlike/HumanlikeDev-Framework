...
class Widget_HumanlikeDev_Speaker_List_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-speaker-list-block';
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Speaker_List_Block() );