...
class Widget_HumanlikeDev_Icon_Text_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'humanlikedev-icon-text-block';
	}
			...
			echo '
				<div class="d-flex mb-3 mb-md-0">';
					...
					if( $settings['image']['id'] ) {
						...
						echo humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-md '. $settings['icon_colour'] );
					}
			...
			echo '
				<div class="d-flex align-items-center my-2">';
					...
					if( $settings['image']['id'] ) {
						...
						echo humanlikedev_svg_icons_pluck( $settings['icon'], 'icon icon-lg '. $settings['icon_colour'] );
					}
			...
			echo '
				<div>
					...
					if( $settings['image']['id'] ) {
						...
						echo humanlikedev_svg_icons_pluck( $settings['icon'], 'icon '. $settings['icon_colour'] );
					}
				...
				<div class="d-flex mb-4">
					<div class="icon-round bg-primary mr-3">';
						...
						if( $settings['image']['id'] ) {
							...
							echo humanlikedev_svg_icons_pluck( $settings['icon'], 'icon bg-primary '. $settings['icon_colour'] );
						}
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_HumanlikeDev_Icon_Text_Block() );