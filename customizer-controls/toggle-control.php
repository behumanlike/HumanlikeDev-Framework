 ...
 * @access public
 */
class Humanlike_Dev_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 
			'login-designer-toggle-control-styles', 
			plugin_dir_url( __FILE__ ) . 'toggle-control.css', 
			false, 
			'1.0.0', 
			'all' 
		);
		...
		wp_enqueue_script( 
			'login-designer-toggle-control-scripts', 
			plugin_dir_url( __FILE__ ) . 'toggle-control.js', 
			array( 'jquery' ), 
			'1.0.0', 
			true 
		);
