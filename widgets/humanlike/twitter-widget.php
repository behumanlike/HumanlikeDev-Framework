...
if(!( class_exists('HumanlikeDev_Twitter_Widget') )){

	class HumanlikeDev_Twitter_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct( 'humanlikedev_twitter', __( 'HumanlikeDev Twitter' ), $widget_ops );
		}
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'user_name' ); ?>">Twitter Username <code>e.g: humanlikedev</code>
	...
	function humanlikedev_register_humanlikedev_twitter(){
	     register_widget( 'HumanlikeDev_Twitter_Widget' );
	}

	add_action( 'widgets_init', 'humanlikedev_register_humanlikedev_twitter', 20 );
