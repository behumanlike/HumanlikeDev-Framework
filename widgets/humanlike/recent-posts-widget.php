...
if(!( class_exists('HumanlikeDev_Recent_Widget') )){
	class HumanlikeDev_Recent_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct( 'humanlikedev_recent_posts', __( 'HumanlikeDev Recent Posts' ), $widget_ops );
		}
	...
	function humanlikedev_register_humanlikedev_recent(){
	     register_widget( 'HumanlikeDev_Recent_Widget' );
	}
	add_action( 'widgets_init', 'humanlikedev_register_humanlikedev_recent', 20);
