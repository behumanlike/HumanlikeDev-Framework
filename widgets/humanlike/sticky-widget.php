...
if(!( class_exists('HumanlikeDev_Sticky_Widget') )){

	class HumanlikeDev_Sticky_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct( 'humanlikedev_sticky', __( 'HumanlikeDev Sticky' ), $widget_ops );
		}
	...
	function humanlikedev_register_humanlikedev_sticky(){
	     register_widget( 'HumanlikeDev_Sticky_Widget' );
	}

	add_action( 'widgets_init', 'humanlikedev_register_humanlikedev_sticky', 20 );
