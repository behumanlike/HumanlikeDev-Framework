...
if(!( class_exists('HumanlikeDev_Popular_Widget') )){
	class HumanlikeDev_Popular_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct( 'humanlikedev_popular_posts', __( 'HumanlikeDev Popular Posts' ), $widget_ops );
		}
	...
	function humanlikedev_register_humanlikedev_popular(){
	     register_widget( 'HumanlikeDev_Popular_Widget' );
	}
	add_action( 'widgets_init', 'humanlikedev_register_humanlikedev_popular', 20);
