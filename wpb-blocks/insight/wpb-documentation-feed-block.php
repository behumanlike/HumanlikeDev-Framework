 ...
 * The Shortcode
 */
function humanlikedev_documentation_feed_shortcode( $atts ) {
...
add_shortcode( 'humanlikedev_documentation_feed', 'humanlikedev_documentation_feed_shortcode' );
/**
 * The VC Functions
 */
function humanlikedev_documentation_feed_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'insight-vc-block',
			"name" => esc_html__("Documention Feed", 'humanlikedev'),
			"base" => "humanlikedev_documentation_feed",
			"category" => esc_html__('Insight WP Theme', 'humanlikedev'),
			'description' => 'Show a list of articles.',
			"params" => array(
				array(
					"type" => "textfield",
					"heading" => esc_html__("Show How Many Posts?", 'humanlikedev'),
					"param_name" => "pppage",
					"value" => '4'
				),
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Article Display Type", 'humanlikedev'),
					"param_name" => "layout",
					"value" => array_flip( humanlikedev_get_documentation_layouts() ),
				),
				array(
					"type" => "textfield",
					"heading" => esc_html__("Offset Posts?", 'humanlikedev'),
					"param_name" => "offset",
					"value" => '0',
...
add_action( 'vc_before_init', 'humanlikedev_documentation_feed_shortcode_vc');