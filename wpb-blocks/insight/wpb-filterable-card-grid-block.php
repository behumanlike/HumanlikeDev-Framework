...
/**
 * humanlikedev_filterable_card_grid_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_filterable_card_grid_shortcode' ) )){
	function humanlikedev_filterable_card_grid_shortcode( $atts, $content = null ) {
	...
	add_shortcode( 'humanlikedev_filterable_card_grid', 'humanlikedev_filterable_card_grid_shortcode' );

}

if(!( function_exists( 'humanlikedev_filterable_card_grid_content_shortcode' ) )){
	function humanlikedev_filterable_card_grid_content_shortcode( $atts, $content = null ) {
	...
	add_shortcode( 'humanlikedev_filterable_card_grid_content', 'humanlikedev_filterable_card_grid_content_shortcode' );
 ...
 * The VC Functions
 */
function humanlikedev_filterable_card_grid_shortcode_vc() {

	vc_map( 
		array(
			"icon" 						=> 'insight-vc-block',
			"name" 						=> __( 'Filterable Card Grid' , 'humanlikedev' ),
			"base" 						=> "humanlikedev_filterable_card_grid",
			"category" 					=> __( 'Insight WP Theme', 'humanlikedev' ),
			'as_parent'               	=> array('only' => 'humanlikedev_filterable_card_grid_content'),
...
add_action( 'vc_before_init', 'humanlikedev_filterable_card_grid_shortcode_vc' );

// Nested Element
function humanlikedev_filterable_card_grid_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" 					=> 'insight-vc-block',
		    'name'            		=> __( 'Filterable Card' , 'humanlikedev' ),
		    'base'            		=> 'humanlikedev_filterable_card_grid_content',
		    'description'     		=> __( 'A simple grid of cards which can be filtered.', 'humanlikedev' ),
		    "category" 				=> __( 'Insight WP Theme', 'humanlikedev' ),
		    'content_element' 		=> true,
		    'as_child'        		=> array('only' => 'humanlikedev_filterable_card_grid'),
		    'params'          => array(
		    	array(
					"type"        => "textfield",
					"heading"     => __( "Card Filter", 'humanlikedev' ),
					"param_name"  => "filter",
					'holder'      => 'div'
				),
	            array(
					"type"       => "dropdown",
					"heading"    => __( "Image & Text Display Type", 'humanlikedev' ),
					"param_name" => "layout",
					"value"      => array(
				...
				array(
					"type"        => "attach_image",
					"heading"     => __( "Card Image", 'humanlikedev' ),
					"param_name"  => "image"
				),
				array(
					"type"        => "textfield",
				...
				array(
					"type"        => "vc_link",
					"heading"     => __( "Card Link", 'humanlikedev' ),
					"param_name"  => "link"
				),
				array(
					"type"        => "textarea_html",
...
add_action( 'vc_before_init', 'humanlikedev_filterable_card_grid_content_shortcode_vc' );

// A must for container functionality, replace Wbc_Item with your base name from mapping for parent container
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_humanlikedev_filterable_card_grid extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_humanlikedev_filterable_card_grid_content extends WPBakeryShortCode {
