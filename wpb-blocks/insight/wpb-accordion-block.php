 ...
 * The Shortcode
 */
function humanlikedev_accordion_shortcode( $atts, $content = null ) {
	extract( 
		shortcode_atts( 
			array(
				'custom_css_class' => ''
...
add_shortcode( 'insight_accordion', 'humanlikedev_accordion_shortcode' );

/**
 * The Shortcode
 */
function humanlikedev_accordion_content_shortcode( $atts, $content = null ) {
	extract( 
		shortcode_atts( 
			array(
				'title' => '',
...
add_shortcode( 'insight_accordion_content', 'humanlikedev_accordion_content_shortcode' );

// Parent Element
function humanlikedev_accordion_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'insight-vc-block',
		    'name'                    => esc_html__( 'Accordion' , 'humanlikedev' ),
		    'base'                    => 'insight_accordion',
		    'description'             => esc_html__( 'Create Accordion Content', 'humanlikedev' ),
...
add_action( 'vc_before_init', 'humanlikedev_accordion_shortcode_vc' );

// Nested Element
function humanlikedev_accordion_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'insight-vc-block',
		    'name'            => esc_html__('Accordion Content', 'humanlikedev'),
		    'base'            => 'insight_accordion_content',
		    'description'     => esc_html__( 'Toggle Content Element', 'humanlikedev' ),
		    "category" => esc_html__('Insight WP Theme', 'humanlikedev'),
		    'content_element' => true,
...
add_action( 'vc_before_init', 'humanlikedev_accordion_content_shortcode_vc' );
