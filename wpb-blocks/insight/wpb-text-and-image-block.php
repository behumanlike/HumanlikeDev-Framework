...
/**
 * humanlikedev_text_image_shortcode()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_text_image_shortcode' ) )){
	function humanlikedev_text_image_shortcode( $atts, $content = null ) {
	...
	add_shortcode( 'humanlikedev_text_image', 'humanlikedev_text_image_shortcode' );
}

/**
 * humanlikedev_text_image_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_text_image_shortcode_vc' ) )){

	function humanlikedev_text_image_shortcode_vc() {
		
		vc_map( 
			array(
				"icon"                    => 'insight-vc-block',
			    'name'                    => __( 'Text + Image' , 'humanlikedev' ),
			    'base'                    => 'humanlikedev_text_image',
	...
	add_action( 'vc_before_init', 'humanlikedev_text_image_shortcode_vc' );
	
	if( class_exists( 'WPBakeryShortCodesContainer' ) ){
	    class WPBakeryShortCode_humanlikedev_text_image extends WPBakeryShortCodesContainer {}
	}
