 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_card_shortcode' ) )){
	function humanlikedev_card_shortcode( $atts, $content = null ){
	...
	add_shortcode( 'humanlikedev_card', 'humanlikedev_card_shortcode' );
}

/**
 * humanlikedev_card_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_card_shortcode_vc' ) )){
	function humanlikedev_card_shortcode_vc(){
		vc_map( 
			array(
				"icon"     => 'insight-vc-block',
				"name"     => __( "Link Card", 'humanlikedev' ),
				"base"     => "humanlikedev_card",
	...
	add_action( 'vc_before_init', 'humanlikedev_card_shortcode_vc' );
}