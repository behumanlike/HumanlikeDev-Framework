...
/**
 * humanlikedev_carousel_shortcode()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_carousel_shortcode' ) )){
	function humanlikedev_carousel_shortcode( $atts, $content = null ){
	...
	add_shortcode( 'humanlikedev_carousel', 'humanlikedev_carousel_shortcode' );
}

/**
 * humanlikedev_carousel_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_carousel_shortcode_vc' ) )){
	function humanlikedev_carousel_shortcode_vc(){
		vc_map( 
			array(
				"icon"     => 'insight-vc-block',
				"name"     => __( "Image Carousel", 'humanlikedev' ),
				"base"     => "humanlikedev_carousel",
				...
				"params"   => array(
					...
					array(
						"type"        => "attach_images",
						"heading"     => __( "Carousel Images", 'humanlikedev' ),
						'description'  	=> __( 'These images will be used in the background of this header area - to have an image link to a page, simply place the URL you wish to link to into the <strong>CAPTION</strong> field.', 'humanlikedev' ),
						"param_name"  => "image"
					),
					array(
						"type"        => "textfield",
	...
	add_action( 'vc_before_init', 'humanlikedev_carousel_shortcode_vc' );
}