...
/**
 * humanlikedev_text_icon_shortcode()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_text_icon_shortcode' ) )){
	function humanlikedev_text_icon_shortcode( $atts, $content = null ) {
	...
	add_shortcode( 'humanlikedev_text_icon', 'humanlikedev_text_icon_shortcode' );
}

/**
 * humanlikedev_text_icon_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_text_icon_shortcode_vc' ) )){

	function humanlikedev_text_icon_shortcode_vc() {
		...
		vc_map( 
			array(
			    ...
			    'name'                    => __( 'Text + Icon' , 'humanlikedev' ),
			    'base'                    => 'humanlikedev_text_icon',
			    ...
			    'params'                  => array(			    	
			    	...
			    	array(
			    		...
			    		"param_name" => "image",
			    		"description" => __( 'Will override icon font if an image is set', 'humanlikedev' ),
			    	),
			    	array(
	...
	add_action( 'vc_before_init', 'humanlikedev_text_icon_shortcode_vc' );
