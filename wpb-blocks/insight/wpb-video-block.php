 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_video_shortcode' ) )){
	function humanlikedev_video_shortcode( $atts, $content = null ){
	...
	add_shortcode( 'humanlikedev_video', 'humanlikedev_video_shortcode' );
}

/**
 * humanlikedev_video_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_video_shortcode_vc' ) )){
	function humanlikedev_video_shortcode_vc(){
		vc_map( 
			array(
				"icon"     => 'insight-vc-block',
				"name"     => __( "Video", 'humanlikedev' ),
				"base"     => "humanlikedev_video",
				"category" => __( 'Insight WP Theme', 'humanlikedev' ),
				"params"   => array(
					array(
			    		"type"       => "dropdown",
			    		"heading"    => __( "Video Display Type", 'humanlikedev' ),
			    		"param_name" => "layout",
			    		"value"      => array(
			    	...
			    	array(
						"type"        => "textfield",
						"heading"     => __( "Video Embed", 'humanlikedev' ),
						"param_name"  => "embed",
						'description' => __( 'Enter link to video <a href="http://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F">(Note: read more about available formats at WordPress codex page).</a>', 'humanlikedev' )
					),					
					array(
						"type"        => "attach_image",
						"heading"     => __( "Video Still Image", 'humanlikedev' ),
						"param_name"  => "image"
					),
					array(
						"type"        => "textarea_html",
	...
	add_action( 'vc_before_init', 'humanlikedev_video_shortcode_vc' );
}