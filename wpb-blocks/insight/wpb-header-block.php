 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_header_shortcode' ) )){
	function humanlikedev_header_shortcode( $atts, $content = null ) {
					...
					<div class="container height-lg-30">
						<div class="row">
							<div class="col-md-8 col-lg-7 col-xl-6">
								'. get_humanlikedev_breadcrumbs( 'breadcrumb p-0 bg-dark bg-transparent' ) .'
			...
			$output = '
				<section class="'. $custom_css_class .'">
					...
					<div class="container height-lg-30">
						<div class="row">
							<div class="col-md-8 col-lg-7 col-xl-6">
								'. get_humanlikedev_breadcrumbs( 'breadcrumb p-0 bg-transparent' ) .'
								'. do_shortcode( $content ) .'
							</div>
						</div>
					</div>
					...
					<div class="container height-lg-50">
						<div class="row justify-content-center text-center">
							<div class="col-lg-10 col-xl-9">
								'. get_humanlikedev_breadcrumbs( 'breadcrumb p-0 bg-dark bg-transparent justify-content-center' ) .'
								'. do_shortcode( $content ) .'
							</div>
						</div>
					</div>
	...
	add_shortcode( 'humanlikedev_header', 'humanlikedev_header_shortcode' );
}

/**
 * humanlikedev_header_shortcode_vc()
 * 
 ...
 * @blame Moiz Farooq
 */
if(!( function_exists( 'humanlikedev_header_shortcode_vc' ) )){

	function humanlikedev_header_shortcode_vc() {
		
		vc_map( 
			array(
				"icon"                    => 'insight-vc-block',
			    'name'                    => __( 'Header' , 'humanlikedev' ),
			    'base'                    => 'humanlikedev_header',
			    'description'             => __( 'Create fancy images & text', 'humanlikedev' ),
			    ...
			    'params'                  => array(
			    	array(
			    		"type"       => "attach_image",
			    		"heading"    => __( "Block Image", 'humanlikedev' ),
			    		"param_name" => "image"
			    	),
			    	array(
			    		"type" => "dropdown",
			    		"heading" => __("Header Background Image Overlay Opacity", 'humanlikedev'),
			    		"param_name" => "opacity",
			    		"value" => array(
			    			'50%' => '50',
			    			'90%' => '90',
			    	...
			    	array(
			    		"type"        => "textfield",
			    		"heading"     => __( "Video Embed/Watch URL", 'humanlikedev' ),
			    	...
			    	array(
			    		"type"       => "attach_image",
			    		"heading"    => __( "Inline Video Cover Image", 'humanlikedev' ),
	...
	add_action( 'vc_before_init', 'humanlikedev_header_shortcode_vc' );
	
	if( class_exists( 'WPBakeryShortCodesContainer' ) ){
	    class WPBakeryShortCode_humanlikedev_header extends WPBakeryShortCodesContainer {}
	}
