 ...
 * The Shortcode
 */
function humanlikedev_card_carousel_shortcode( $atts, $content = null ) {
...
add_shortcode( 'insight_card_carousel', 'humanlikedev_card_carousel_shortcode' );

/**
 * The Shortcode
 */
function humanlikedev_card_carousel_content_shortcode( $atts, $content = null, $carousel_layout ) {
...
add_shortcode( 'insight_card_carousel_content', 'humanlikedev_card_carousel_content_shortcode' );

// Parent Element
function humanlikedev_card_carousel_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'insight-vc-block',
		    'name'                    => esc_html__( 'Card Carousel List' , 'humanlikedev' ),
		    ...
		    'params'          => array(
		    	array(
					"type"       => "dropdown",
					"heading"    => __( "Carousel Display Type", 'humanlikedev' ),
...
add_action( 'vc_before_init', 'humanlikedev_card_carousel_shortcode_vc' );

// Nested Element
function humanlikedev_card_carousel_content_shortcode_vc() {
	...
	vc_map( 
		array(
			"icon" => 'insight-vc-block',
		    'name'            => esc_html__('Card Carousel Item', 'humanlikedev'),
		    ...
		    'params'          => array(
		    	array(
		    		"type"       => "dropdown",
		    		"heading"    => __( "Card Display Type", 'humanlikedev' ),
		    		"param_name" => "layout",
		    		"value"      => array(
...
add_action( 'vc_before_init', 'humanlikedev_card_carousel_content_shortcode_vc' );
